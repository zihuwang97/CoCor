...
def argparser():
    ...
    parser.add_argument('--d_lr', default=0.05, type=float,
                         help='initial softmax learning rate')
    parser.add_argument('--lin_lr', default=0.4, type=float,
                        help='initial lin learning rate')
    ...
    parser.add_argument('--dataset', type=str, default="ImageNet", help="Specify dataset: default: ImageNet")
